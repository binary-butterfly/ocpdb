...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            'category',
            sa.Enum('CHARGER', 'ENTRANCE', 'LOCATION', 'NETWORK', 'OPERATOR', 'OTHER', 'OWNER', name='imagecategory'),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column('dynamic_location_id', sa.BigInteger(), nullable=True),
        sa.Column('dynamic_location_probability', sa.Float(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            'type',
            sa.Enum('string', 'date', 'datetime', 'integer', 'decimal', 'dict', 'list', name='OptionType'),
            nullable=True,
        ),
