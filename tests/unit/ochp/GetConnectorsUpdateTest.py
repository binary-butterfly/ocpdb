...
from webapp.services.ochp.SaveConnector import get_connector_updates
from webapp.services.ochp.Helper import get_nsmap


class GetConnectorsUpdateTest(BaseTestCase):
    ...
    def test_xml_to_update(self):
        ...
        connectors = get_connector_updates(data_chargepoint)
