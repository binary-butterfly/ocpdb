...
giroe_location_input_schema = JsonSchema(
    ...
    properties={
        ...
        'created': DateTimeField(),
        'modified': DateTimeField(),
        # giro-e sends coordinates as decimal strings, and that is what the validator accepts: a JSON number
        # would be rejected with a 400.
        'lat': DecimalField(precision=9, scale=7, description='Latitude (WGS84)'),
        'lon': DecimalField(precision=10, scale=7, description='Longitude (WGS84)'),
        'address': StringField(),
