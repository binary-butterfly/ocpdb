...
class ExceptionalOpeningPeriod(db.Model, BaseModel):
    __tablename__ = 'exceptional_opening_period'

    location: Mapped['Location'] = db.relationship('Location', back_populates='exceptional_openings')
