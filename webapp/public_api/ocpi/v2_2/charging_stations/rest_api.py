...
class OcpiChargingStationBlueprint(BaseBlueprint):
    documented = True
    ...
    def __init__(self):
        ...
        super().__init__('ocpi_charging_stations', __name__, url_prefix='/charge-stations')

        self.add_url_rule(
            '',
            view_func=OcpiChargingStationListMethodView.as_view(
                'ocpi_charging_stations',
        ...
        self.add_url_rule(
            ...
            view_func=OcpiChargingStationItemMethodView.as_view(
                'ocpi_charging_station',
                **self.get_base_method_view_dependencies(),
                charging_station_handler=self.charging_station_handler,
            ),
        )
...
class OcpiChargingStationBaseMethodView(BaseMethodView):
    charging_station_handler: ChargingStationHandler
...
class OcpiChargingStationListMethodView(OcpiChargingStationBaseMethodView):
...
class OcpiChargingStationItemMethodView(OcpiChargingStationBaseMethodView):
    @document(
