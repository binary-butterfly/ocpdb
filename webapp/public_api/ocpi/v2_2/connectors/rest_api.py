...
class OcpiConnectorBlueprint(BaseBlueprint):
    ...
    def __init__(self):
        ...
        super().__init__('ocpi_connectors', __name__, url_prefix='/connectors')

        self.add_url_rule(
            '',
            view_func=OcpiConnectorListMethodView.as_view(
                'ocpi_connectors',
        ...
        self.add_url_rule(
            '/<int:connector_id>',
            view_func=OcpiConnectorItemMethodView.as_view(
                'ocpi_connector',
                **self.get_base_method_view_dependencies(),
                connector_handler=self.connector_handler,
            ),
...
class OcpiConnectorBaseMethodView(BaseMethodView):
    connector_handler: ConnectorHandler
...
class OcpiConnectorListMethodView(OcpiConnectorBaseMethodView):
...
class OcpiConnectorItemMethodView(OcpiConnectorBaseMethodView):
    @document(
