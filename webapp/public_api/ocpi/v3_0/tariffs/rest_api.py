...
class Ocpi30TariffBlueprint(BaseBlueprint):
    documented = True
    ...
    def __init__(self):
        ...
        super().__init__('ocpi_30_tariffs', __name__, url_prefix='/tariffs')

        self.add_url_rule(
            '',
            view_func=Ocpi30TariffListMethodView.as_view(
                'ocpi_30_tariffs',
        ...
        self.add_url_rule(
            '/<int:tariff_id>',
            view_func=Ocpi30TariffItemMethodView.as_view(
                'ocpi_30_tariff',
                **self.get_base_method_view_dependencies(),
                tariff_handler=self.tariff_handler,
            ),
...
class Ocpi30TariffBaseMethodView(BaseMethodView):
    tariff_handler: TariffHandler
...
class Ocpi30TariffListMethodView(Ocpi30TariffBaseMethodView):
...
class Ocpi30TariffItemMethodView(Ocpi30TariffBaseMethodView):
    @document(
