...
class Ocpi30EvseBlueprint(BaseBlueprint):
    documented = True
    ...
    def __init__(self):
        ...
        super().__init__('ocpi_30_evses', __name__, url_prefix='/evses')

        self.add_url_rule(
            '',
            view_func=Ocpi30EvseListMethodView.as_view(
                'ocpi_30_evses',
        ...
        self.add_url_rule(
            '/<int:evse_id>',
            view_func=Ocpi30EvseItemMethodView.as_view(
                'ocpi_30_evse',
                **self.get_base_method_view_dependencies(),
                evse_handler=self.evse_handler,
            ),
...
class Ocpi30EvseBaseMethodView(BaseMethodView):
    evse_handler: EvseHandler
...
class Ocpi30EvseListMethodView(Ocpi30EvseBaseMethodView):
...
class Ocpi30EvseItemMethodView(Ocpi30EvseBaseMethodView):
    @document(
