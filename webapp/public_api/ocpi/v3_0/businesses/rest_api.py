...
class Ocpi30BusinessBlueprint(BaseBlueprint):
    ...
    def __init__(self):
        ...
        super().__init__('ocpi_30_businesses', __name__, url_prefix='/businesses')

        self.add_url_rule(
            '',
            view_func=Ocpi30BusinessListMethodView.as_view(
                'ocpi_30_businesses',
        ...
        self.add_url_rule(
            '/<int:business_id>',
            view_func=Ocpi30BusinessItemMethodView.as_view(
                'ocpi_30_business',
                **self.get_base_method_view_dependencies(),
                business_handler=self.business_handler,
            ),
...
class Ocpi30BusinessBaseMethodView(BaseMethodView):
    business_handler: BusinessHandler
...
class Ocpi30BusinessListMethodView(Ocpi30BusinessBaseMethodView):
...
class Ocpi30BusinessItemMethodView(Ocpi30BusinessBaseMethodView):
    @document(
