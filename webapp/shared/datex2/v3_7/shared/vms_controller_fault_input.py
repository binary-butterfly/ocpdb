...
class VmsControllerFaultInput(ValidataclassMixin):
    ...
    vmsControllerFault: VmsControllerFaultEnumGInput = DataclassValidator(VmsControllerFaultEnumGInput)
    comFaultExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    vmsVmsControllerFaultExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
