...
@validataclass
class SupplementaryPanelAreaInput(ValidataclassMixin):
    ...
    supplementaryPictogramCodeListIdentifier: str | UnsetValueType = StringValidator(), Default(UnsetValue)
    relatedPictogramArea: int | UnsetValueType = IntegerValidator(), Default(UnsetValue)
    ...
    vmsSupplementaryPanelAreaExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
