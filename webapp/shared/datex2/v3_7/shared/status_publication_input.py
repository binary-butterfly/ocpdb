...
class StatusPublicationInput(ValidataclassMixin):
    ...
    status: list[StatusInput] | UnsetValueType = ListValidator(DataclassValidator(StatusInput)), Default(UnsetValue)
    statusOfAllDevicesFromTable: list[StatusOfAllDevicesFromTableInput] | UnsetValueType = (
        ListValidator(DataclassValidator(StatusOfAllDevicesFromTableInput)),
        Default(UnsetValue),
    )
    ...
    fstStatusPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
