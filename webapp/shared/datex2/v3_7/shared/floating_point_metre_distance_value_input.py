...
@validataclass
class FloatingPointMetreDistanceValueInput(ValidataclassMixin):
    ...
    distance: float = FloatValidator(allow_integers=True)
    comDataValueExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    comFloatingPointMetreDistanceValueExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
