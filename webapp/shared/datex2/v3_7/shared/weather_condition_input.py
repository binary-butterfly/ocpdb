...
@validataclass
class WeatherConditionInput(ValidataclassMixin):
    ...
    weatherConditionType: WeatherRelatedRoadConditionTypeEnumGInput = DataclassValidator(
    ...
    troWeatherConditionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
