...
@validataclass
class LinearElementByCodeInput(ValidataclassMixin):
    ...
    linearElementIdentifier: str = StringValidator()
    locLinearElementExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    locLinearElementByCodeExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
