...
class DangerousGoodsExtendedInput(ValidataclassMixin):
    ...
    volumeOfDangerousGoods: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    weightOfDangerousGoods: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
