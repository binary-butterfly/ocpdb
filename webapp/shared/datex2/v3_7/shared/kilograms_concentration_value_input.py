...
@validataclass
class KilogramsConcentrationValueInput(ValidataclassMixin):
    ...
    kilogramsConcentration: float = FloatValidator(allow_integers=True)
    comDataValueExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    comKilogramsConcentrationValueExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
