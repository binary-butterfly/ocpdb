...
class NonVehicularRoadUserConditionInput(ValidataclassMixin):
    ...
    nonVehicularRoadUser: NonVehicularRoadUserTypeEnumGInput = DataclassValidator(NonVehicularRoadUserTypeEnumGInput)
    ...
    troNonVehicularRoadUserConditionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
