...
class PhysicalQuantityFaultInput(ValidataclassMixin):
    ...
    physicalQuantityFaultType: PhysicalQuantityFaultEnumGInput = DataclassValidator(PhysicalQuantityFaultEnumGInput)
    comFaultExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    roaPhysicalQuantityFaultExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
