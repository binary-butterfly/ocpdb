...
@validataclass
class MicrogramsConcentrationValueInput(ValidataclassMixin):
    ...
    microgramsConcentration: float = FloatValidator(allow_integers=True)
    comDataValueExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    comMicrogramsConcentrationValueExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
