...
from .calendar_week_within_month_enum_g_output import CalendarWeekWithinMonthEnumGOutput
...
class CalendarWeekWithinMonthOutput:
    applicableDay: list[DayEnumGOutput] | None = None
    applicableMonth: list[MonthOfYearEnumGOutput] | None = None
    applicableCalenderWeekWithinMonth: list[CalendarWeekWithinMonthEnumGOutput]
    comDayWeekMonthExtensionG: DayWeekMonthExtensionTypeGOutput | None = None
    comCalendarWeekWithinMonthExtensionG: ExtensionTypeGOutput | None = None
