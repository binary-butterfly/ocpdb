...
class PictogramDisplayAreaInput(ValidataclassMixin):
    ...
    pictogramCodeListIdentifier: str | UnsetValueType = StringValidator(), Default(UnsetValue)
    pictogramNumberOfColours: int | UnsetValueType = IntegerValidator(min_value=0), Default(UnsetValue)
    ...
    vmsPictogramDisplayAreaExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
