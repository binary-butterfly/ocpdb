...
class AlertCLinearByCodeInput(ValidataclassMixin):
    ...
    locationCodeForLinearLocation: AlertCLocationInput = DataclassValidator(AlertCLocationInput)
    locAlertCLinearExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    locAlertCLinearByCodeExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
