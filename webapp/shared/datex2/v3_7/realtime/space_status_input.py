...
@validataclass
class SpaceStatusInput(ValidataclassMixin):
    ...
    measurementOrCalculationTime: datetime | UnsetValueType = DateTimeValidator(), Default(UnsetValue)
    ...
    prkSpaceStatusExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
