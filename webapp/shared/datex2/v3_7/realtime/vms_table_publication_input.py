...
from .vms_controller_table_input import VmsControllerTableInput


@validataclass
class VmsTablePublicationInput(ValidataclassMixin):
    ...
    vmsControllerTable: list[VmsControllerTableInput] = ListValidator(DataclassValidator(VmsControllerTableInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    vmsVmsTablePublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
