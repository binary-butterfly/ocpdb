...
from webapp.shared.datex2.v3_7.shared.parking_place_status_enum_g_input import ParkingPlaceStatusEnumGInput
...
@validataclass
class PlaceStatusInput(ValidataclassMixin):
    ...
    status: list[ParkingPlaceStatusEnumGInput] | UnsetValueType = (
        ListValidator(DataclassValidator(ParkingPlaceStatusEnumGInput)),
        Default(UnsetValue),
    )
    parkingPlaceFullAtFloor: list[str] | UnsetValueType = ListValidator(StringValidator()), Default(UnsetValue)
    declarationValidNow: bool | UnsetValueType = BooleanValidator(), Default(UnsetValue)
    ...
    prkPlaceStatusExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
