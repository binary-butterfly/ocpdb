...
from webapp.shared.datex2.v3_7.shared.construction_work_type_enum_g_input import ConstructionWorkTypeEnumGInput
...
class ConstructionWorksInput(ValidataclassMixin):
    ...
    constructionWorkType: ConstructionWorkTypeEnumGInput = DataclassValidator(ConstructionWorkTypeEnumGInput)
    ...
    sitConstructionWorksExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
