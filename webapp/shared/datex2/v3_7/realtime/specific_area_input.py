...
@validataclass
class SpecificAreaInput(ValidataclassMixin):
    ...
    characteristics: CharacteristicsInput | UnsetValueType = (
        DataclassValidator(CharacteristicsInput),
        Default(UnsetValue),
    )
    ...
    prkSpecificAreaExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
