...
from .measurement_site_table_input import MeasurementSiteTableInput


@validataclass
class MeasurementSiteTablePublicationInput(ValidataclassMixin):
    ...
    measurementSiteTable: list[MeasurementSiteTableInput] = ListValidator(DataclassValidator(MeasurementSiteTableInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    roaMeasurementSiteTablePublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
