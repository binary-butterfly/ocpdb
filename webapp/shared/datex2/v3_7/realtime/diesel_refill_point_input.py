...
from webapp.shared.datex2.v3_7.shared.diesel_type_enum_g_input import DieselTypeEnumGInput
...
class DieselRefillPointInput(ValidataclassMixin):
    ...
    dieselType: list[DieselTypeEnumGInput] | UnsetValueType = (
        ListValidator(DataclassValidator(DieselTypeEnumGInput)),
        Default(UnsetValue),
    )
    ...
    egiDieselRefillPointExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
