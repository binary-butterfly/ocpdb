...
@validataclass
class TrafficSignalSettingDefinitionInput(ValidataclassMixin):
    ...
    tmpTrafficSignalSettingDefinitionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
