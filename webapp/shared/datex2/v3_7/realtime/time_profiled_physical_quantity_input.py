...
class TimeProfiledPhysicalQuantityInput(ValidataclassMixin):
    ...
    basicData: list[BasicDataGInput] | UnsetValueType = (
        ListValidator(DataclassValidator(BasicDataGInput)),
        Default(UnsetValue),
    )
    ...
    roaTimeProfiledPhysicalQuantityExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
