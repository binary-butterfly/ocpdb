...
from webapp.shared.datex2.v3_7.shared.organic_gas_type_enum_g_input import OrganicGasTypeEnumGInput
...
@validataclass
class OrganicGasRefillPointInput(ValidataclassMixin):
    ...
    organicGasType: list[OrganicGasTypeEnumGInput] | UnsetValueType = (
        ListValidator(DataclassValidator(OrganicGasTypeEnumGInput)),
        Default(UnsetValue),
    )
    ...
    egiOrganicGasRefillPointExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
