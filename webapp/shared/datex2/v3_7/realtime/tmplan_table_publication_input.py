...
from .tmplan_table_input import TmplanTableInput


@validataclass
class TmplanTablePublicationInput(ValidataclassMixin):
    ...
    tmplanTable: list[TmplanTableInput] = ListValidator(DataclassValidator(TmplanTableInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    tmpTmplanTablePublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
