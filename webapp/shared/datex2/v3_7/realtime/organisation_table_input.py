...
from .organisation_specification_input import OrganisationSpecificationInput


@validataclass
class OrganisationTableInput(ValidataclassMixin):
    ...
    organisationSpecification: list[OrganisationSpecificationInput] = ListValidator(
        DataclassValidator(OrganisationSpecificationInput)
    )
    facOrganisationTableExtensionG: ExtensionTypeGInput | UnsetValueType = (
