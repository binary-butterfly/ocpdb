...
class PetrolRefillPointInput(ValidataclassMixin):
    ...
    petrolType: list[PetrolTypeEnumGInput] | UnsetValueType = (
        ListValidator(DataclassValidator(PetrolTypeEnumGInput)),
        Default(UnsetValue),
    )
    octane: int | UnsetValueType = IntegerValidator(min_value=0), Default(UnsetValue)
    bioethanolPercentage: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    ...
    egiPetrolRefillPointExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
