...
from .predefined_location_reference_g_input import PredefinedLocationReferenceGInput


@validataclass
class PredefinedLocationsPublicationInput(ValidataclassMixin):
    ...
    predefinedLocationReference: list[PredefinedLocationReferenceGInput] = ListValidator(
        DataclassValidator(PredefinedLocationReferenceGInput)
    )
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    locPredefinedLocationsPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
