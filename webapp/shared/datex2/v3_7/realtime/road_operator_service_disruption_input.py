...
from webapp.shared.datex2.v3_7.shared.road_operator_service_disruption_type_enum_g_input import (
    RoadOperatorServiceDisruptionTypeEnumGInput,
)
...
@validataclass
class RoadOperatorServiceDisruptionInput(ValidataclassMixin):
    ...
    roadOperatorServiceDisruptionType: list[RoadOperatorServiceDisruptionTypeEnumGInput] = ListValidator(
        DataclassValidator(RoadOperatorServiceDisruptionTypeEnumGInput)
    )
    ...
    sitRoadOperatorServiceDisruptionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
