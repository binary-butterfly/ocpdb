...
from webapp.shared.datex2.v3_7.shared.campus_status_enum_g_input import CampusStatusEnumGInput
...
@validataclass
class CampusStatusInput(ValidataclassMixin):
    ...
    status: CampusStatusEnumGInput | UnsetValueType = DataclassValidator(CampusStatusEnumGInput), Default(UnsetValue)
    ...
    prkCampusStatusExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
