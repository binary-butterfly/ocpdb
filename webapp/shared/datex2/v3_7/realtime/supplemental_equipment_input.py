...
from webapp.shared.datex2.v3_7.shared.availability_enum_g_input import AvailabilityEnumGInput
from webapp.shared.datex2.v3_7.shared.dimension_input import DimensionInput
from webapp.shared.datex2.v3_7.shared.equipment_type_enum_g_input import EquipmentTypeEnumGInput
...
class SupplementalEquipmentInput(ValidataclassMixin):
    ...
    equipmentType: EquipmentTypeEnumGInput = DataclassValidator(EquipmentTypeEnumGInput)
    ...
    afacSupplementalEquipmentExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
