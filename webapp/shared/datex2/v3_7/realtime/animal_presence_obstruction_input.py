...
from webapp.shared.datex2.v3_7.shared.animal_presence_type_enum_g_input import AnimalPresenceTypeEnumGInput
...
class AnimalPresenceObstructionInput(ValidataclassMixin):
    ...
    alive: bool | UnsetValueType = BooleanValidator(), Default(UnsetValue)
    animalPresenceType: AnimalPresenceTypeEnumGInput = DataclassValidator(AnimalPresenceTypeEnumGInput)
    ...
    sitAnimalPresenceObstructionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
