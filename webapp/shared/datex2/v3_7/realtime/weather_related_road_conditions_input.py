...
from webapp.shared.datex2.v3_7.shared.road_surface_condition_measurements_input import (
...
from webapp.shared.datex2.v3_7.shared.weather_related_road_condition_type_enum_g_input import (
    WeatherRelatedRoadConditionTypeEnumGInput,
)
...
@validataclass
class WeatherRelatedRoadConditionsInput(ValidataclassMixin):
    ...
    weatherRelatedRoadConditionType: list[WeatherRelatedRoadConditionTypeEnumGInput] = ListValidator(
        DataclassValidator(WeatherRelatedRoadConditionTypeEnumGInput)
    )
    ...
    roadSurfaceConditionMeasurements: RoadSurfaceConditionMeasurementsInput | UnsetValueType = (
        DataclassValidator(RoadSurfaceConditionMeasurementsInput),
        Default(UnsetValue),
    )
    ...
    sitRoadSurfaceConditionsExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    sitWeatherRelatedRoadConditionsExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
