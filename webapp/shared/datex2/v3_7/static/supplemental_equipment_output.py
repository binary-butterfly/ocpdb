...
from .equipment_type_enum_g_output import EquipmentTypeEnumGOutput
...
class SupplementalEquipmentOutput:
    idG: str
    versionG: str
    ...
    equipmentType: EquipmentTypeEnumGOutput
    ...
    afacSupplementalEquipmentExtensionG: ExtensionTypeGOutput | None = None
