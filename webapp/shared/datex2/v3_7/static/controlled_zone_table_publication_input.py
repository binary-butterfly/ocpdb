...
class ControlledZoneTablePublicationInput(ValidataclassMixin):
    ...
    controlledZoneTable: list[ControlledZoneTableInput] = ListValidator(DataclassValidator(ControlledZoneTableInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    czControlledZoneTablePublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
