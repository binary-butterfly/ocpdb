...
from .an_organisation_g_input import AnOrganisationGInput
...
class OrganisationTableInput(ValidataclassMixin):
    ...
    anOrganisation: list[AnOrganisationGInput] = ListValidator(DataclassValidator(AnOrganisationGInput))
    afacOrganisationTableExtensionG: ExtensionTypeGInput | UnsetValueType = (
