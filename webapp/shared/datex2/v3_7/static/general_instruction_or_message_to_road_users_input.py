...
@validataclass
class GeneralInstructionOrMessageToRoadUsersInput(ValidataclassMixin):
    ...
    sitGeneralInstructionOrMessageToRoadUsersExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
