...
from webapp.shared.datex2.v3_7.shared.maintenance_vehicles_input import MaintenanceVehiclesInput
...
from webapp.shared.datex2.v3_7.shared.road_maintenance_type_enum_g_input import RoadMaintenanceTypeEnumGInput
from webapp.shared.datex2.v3_7.shared.roadworks_duration_enum_g_input import RoadworksDurationEnumGInput
from webapp.shared.datex2.v3_7.shared.roadworks_extension_type_g_input import RoadworksExtensionTypeGInput
from webapp.shared.datex2.v3_7.shared.roadworks_scale_enum_g_input import RoadworksScaleEnumGInput
...
from webapp.shared.datex2.v3_7.shared.subjects_input import SubjectsInput
...
@validataclass
class MaintenanceWorksInput(ValidataclassMixin):
    ...
    publicTransportAlternative: MultilingualStringInput | UnsetValueType = (
        DataclassValidator(MultilingualStringInput),
        Default(UnsetValue),
    )
    roadworksDurationClassification: RoadworksDurationEnumGInput | UnsetValueType = (
        DataclassValidator(RoadworksDurationEnumGInput),
        Default(UnsetValue),
    )
    roadworksIdentifier: str | UnsetValueType = StringValidator(), Default(UnsetValue)
    roadworksScale: RoadworksScaleEnumGInput | UnsetValueType = (
        DataclassValidator(RoadworksScaleEnumGInput),
        Default(UnsetValue),
    )
    underTraffic: bool | UnsetValueType = BooleanValidator(), Default(UnsetValue)
    urgentRoadworks: bool | UnsetValueType = BooleanValidator(), Default(UnsetValue)
    roadMaintenanceType: list[RoadMaintenanceTypeEnumGInput] = ListValidator(
        DataclassValidator(RoadMaintenanceTypeEnumGInput)
    )
    ...
    mobility: MobilityInput | UnsetValueType = DataclassValidator(MobilityInput), Default(UnsetValue)
    subjects: SubjectsInput | UnsetValueType = DataclassValidator(SubjectsInput), Default(UnsetValue)
    maintenanceVehicles: MaintenanceVehiclesInput | UnsetValueType = (
        DataclassValidator(MaintenanceVehiclesInput),
        Default(UnsetValue),
    )
    ...
    sitRoadworksExtensionG: RoadworksExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(RoadworksExtensionTypeGInput),
        Default(UnsetValue),
    )
    sitMaintenanceWorksExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
