...
@validataclass
class TrafficGapInput(ValidataclassMixin):
    ...
    averageDistanceGap: FloatingPointMetreDistanceValueInput | UnsetValueType = (
        DataclassValidator(FloatingPointMetreDistanceValueInput),
        Default(UnsetValue),
    )
    averageTimeGap: DurationValueInput | UnsetValueType = DataclassValidator(DurationValueInput), Default(UnsetValue)
    ...
    roaTrafficGapExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
