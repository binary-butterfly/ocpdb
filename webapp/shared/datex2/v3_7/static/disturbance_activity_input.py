...
from webapp.shared.datex2.v3_7.shared.disturbance_activity_type_enum_g_input import DisturbanceActivityTypeEnumGInput
...
@validataclass
class DisturbanceActivityInput(ValidataclassMixin):
    ...
    disturbanceActivityType: DisturbanceActivityTypeEnumGInput = DataclassValidator(DisturbanceActivityTypeEnumGInput)
    ...
    mobilityOfActivity: MobilityInput | UnsetValueType = DataclassValidator(MobilityInput), Default(UnsetValue)
    ...
    sitActivityExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    sitDisturbanceActivityExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
