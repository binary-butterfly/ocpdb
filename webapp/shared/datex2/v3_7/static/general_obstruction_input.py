...
from webapp.shared.datex2.v3_7.shared.obstruction_type_enum_g_input import ObstructionTypeEnumGInput
...
@validataclass
class GeneralObstructionInput(ValidataclassMixin):
    ...
    obstructionType: list[ObstructionTypeEnumGInput] = ListValidator(DataclassValidator(ObstructionTypeEnumGInput))
    ...
    sitGeneralObstructionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
