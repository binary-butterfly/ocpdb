...
@validataclass
class TemporaryTrafficRegulationOrderInput(ValidataclassMixin):
    ...
    overruledTrafficRegulationOrder: list[TrafficRegulationOrderVersionedReferenceGInput] | UnsetValueType = (
    ...
    troTemporaryTrafficRegulationOrderExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
