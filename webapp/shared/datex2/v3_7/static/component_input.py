...
from webapp.shared.datex2.v3_7.shared.device_component_enum_g_input import DeviceComponentEnumGInput
...
class ComponentInput(ValidataclassMixin):
    ...
    componentType: DeviceComponentEnumGInput = DataclassValidator(DeviceComponentEnumGInput)
    ...
    fstComponentExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
