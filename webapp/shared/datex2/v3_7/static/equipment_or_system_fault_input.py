...
from webapp.shared.datex2.v3_7.shared.equipment_or_system_fault_type_enum_g_input import (
    EquipmentOrSystemFaultTypeEnumGInput,
)
from webapp.shared.datex2.v3_7.shared.equipment_or_system_type_enum_g_input import EquipmentOrSystemTypeEnumGInput
...
@validataclass
class EquipmentOrSystemFaultInput(ValidataclassMixin):
    ...
    equipmentOrSystemFaultType: EquipmentOrSystemFaultTypeEnumGInput = DataclassValidator(
        EquipmentOrSystemFaultTypeEnumGInput
    )
    faultyEquipmentOrSystemType: EquipmentOrSystemTypeEnumGInput = DataclassValidator(EquipmentOrSystemTypeEnumGInput)
    ...
    sitEquipmentOrSystemFaultExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
