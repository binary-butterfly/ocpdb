...
@validataclass
class PublicEventInput(ValidataclassMixin):
    ...
    publicEventType: PublicEventTypeEnumGInput = DataclassValidator(PublicEventTypeEnumGInput)
    venueName: MultilingualStringInput | UnsetValueType = (
    ...
    sitPublicEventExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
