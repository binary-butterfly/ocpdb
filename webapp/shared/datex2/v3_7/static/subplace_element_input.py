...
from webapp.shared.datex2.v3_7.shared.element_descriptor_enum_g_input import ElementDescriptorEnumGInput
...
@validataclass
class SubplaceElementInput(ValidataclassMixin):
    ...
    subplaceType: ElementDescriptorEnumGInput | UnsetValueType = (
        DataclassValidator(ElementDescriptorEnumGInput),
        Default(UnsetValue),
    )
    ...
    prkSubplaceElementExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
