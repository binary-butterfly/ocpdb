...
from webapp.shared.datex2.v3_7.shared.authority_operation_type_enum_g_input import AuthorityOperationTypeEnumGInput
...
@validataclass
class AuthorityOperationInput(ValidataclassMixin):
    ...
    authorityOperationType: AuthorityOperationTypeEnumGInput = DataclassValidator(AuthorityOperationTypeEnumGInput)
    ...
    sitAuthorityOperationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
