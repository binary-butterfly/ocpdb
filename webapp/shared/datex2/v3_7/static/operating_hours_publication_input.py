...
from .operating_hours_table_input import OperatingHoursTableInput


@validataclass
class OperatingHoursPublicationInput(ValidataclassMixin):
    ...
    operatingHoursTable: list[OperatingHoursTableInput] = ListValidator(DataclassValidator(OperatingHoursTableInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    afacOperatingHoursPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
