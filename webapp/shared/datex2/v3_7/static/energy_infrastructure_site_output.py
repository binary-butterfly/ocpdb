...
from .energy_infrastructure_site_type_enum_g_output import EnergyInfrastructureSiteTypeEnumGOutput
from .energy_infrastructure_station_output import EnergyInfrastructureStationOutput
from .external_identifier_output import ExternalIdentifierOutput
from .image_output import ImageOutput
from .location_g_output import LocationGOutput
...
class EnergyInfrastructureSiteOutput:
    idG: str
    versionG: str
    ...
    typeOfSite: EnergyInfrastructureSiteTypeEnumGOutput | None = None
    brand: MultilingualStringOutput | None = None
    exclusiveUsers: list[UserTypeEnumGOutput] | None = None
    preferredUsers: list[UserTypeEnumGOutput] | None = None
    ...
    entrance: list[LocationGOutput] | None = None
    exit: list[LocationGOutput] | None = None
    energyInfrastructureStation: list[EnergyInfrastructureStationOutput] | None = None
    ...
    aegiEnergyInfrastructureSiteExtensionG: ExtensionTypeGOutput | None = None
