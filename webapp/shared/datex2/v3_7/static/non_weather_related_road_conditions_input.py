...
from webapp.shared.datex2.v3_7.shared.non_weather_related_road_condition_type_enum_g_input import (
    NonWeatherRelatedRoadConditionTypeEnumGInput,
)
...
@validataclass
class NonWeatherRelatedRoadConditionsInput(ValidataclassMixin):
    ...
    nonWeatherRelatedRoadConditionType: list[NonWeatherRelatedRoadConditionTypeEnumGInput] = ListValidator(
        DataclassValidator(NonWeatherRelatedRoadConditionTypeEnumGInput)
    )
    ...
    sitNonWeatherRelatedRoadConditionsExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
