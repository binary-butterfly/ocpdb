...
from .organisation_table_input import OrganisationTableInput


@validataclass
class OrganisationPublicationInput(ValidataclassMixin):
    ...
    organisationTable: list[OrganisationTableInput] = ListValidator(DataclassValidator(OrganisationTableInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    afacOrganisationPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
