...
class ConnectorTypeEnum(Enum):
    ...
    YAZAKI = 'yazaki'
    DOMESTIC = 'domestic'
    DOMESTICATYPE = 'domesticAType'
    DOMESTICBTYPE = 'domesticBType'
    DOMESTICCTYPE = 'domesticCType'
    DOMESTICDTYPE = 'domesticDType'
    DOMESTICETYPE = 'domesticEType'
    DOMESTICFTYPE = 'domesticFType'
    DOMESTICGTYPE = 'domesticGType'
    DOMESTICHTYPE = 'domesticHType'
    DOMESTICITYPE = 'domesticIType'
    DOMESTICJTYPE = 'domesticJType'
    DOMESTICKTYPE = 'domesticKType'
    DOMESTICLTYPE = 'domesticLType'
    DOMESTICMTYPE = 'domesticMType'
    DOMESTICNTYPE = 'domesticNType'
    DOMESTICOTYPE = 'domesticOType'
