...
from .service_facility_type_enum_g_output import ServiceFacilityTypeEnumGOutput
from .url_link_output import UrlLinkOutput


@dataclass(kw_only=True)
class SupplementalServiceFacilityOutput:
    idG: str
    versionG: str
    ...
    serviceFacilityType: ServiceFacilityTypeEnumGOutput
    numberOfSubitems: int | None = None
    distanceFromOriginFacility: int | None = None
    ...
    afacSupplementalServiceFacilityExtensionG: ExtensionTypeGOutput | None = None
