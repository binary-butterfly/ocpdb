...
from webapp.shared.datex2.v3_7.shared.diesel_vehicle_type_enum_g_input import DieselVehicleTypeEnumGInput
...
@validataclass
class DieselRefillPointInput(ValidataclassMixin):
    ...
    dieselVehicleType: DieselVehicleTypeEnumGInput | UnsetValueType = (
        DataclassValidator(DieselVehicleTypeEnumGInput),
        Default(UnsetValue),
    )
    cetane: int | UnsetValueType = IntegerValidator(min_value=0), Default(UnsetValue)
    bioDieselShare: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    ...
    aegiDieselRefillPointExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
