...
from webapp.shared.datex2.v3_7.shared.gas_connector_type_enum_g_input import GasConnectorTypeEnumGInput
...
@validataclass
class AlternativeFuelsRefillPointInput(ValidataclassMixin):
    ...
    connector: list[GasConnectorTypeEnumGInput] | UnsetValueType = (
        ListValidator(DataclassValidator(GasConnectorTypeEnumGInput)),
        Default(UnsetValue),
    )
    otherConnector: list[str] | UnsetValueType = ListValidator(StringValidator()), Default(UnsetValue)
    hydrogenProcessProtocol: HydrogenFuellingProcessProtocolEnumGInput | UnsetValueType = (
    ...
    pressure: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    ...
    aegiAlternativeFuelsRefillPointExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
