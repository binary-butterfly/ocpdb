...
from webapp.shared.datex2.v3_7.shared.speed_management_type_enum_g_input import SpeedManagementTypeEnumGInput
...
@validataclass
class SpeedManagementDefinitionInput(ValidataclassMixin):
    ...
    speedManagementType: SpeedManagementTypeEnumGInput = DataclassValidator(SpeedManagementTypeEnumGInput)
    temporarySpeedLimit: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    ...
    tmpSpeedManagementDefinitionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
