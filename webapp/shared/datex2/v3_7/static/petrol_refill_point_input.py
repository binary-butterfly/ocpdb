...
from webapp.shared.datex2.v3_7.shared.octane_type_enum_g_input import OctaneTypeEnumGInput
...
from .bioethanol_type_enum_g_input import BioethanolTypeEnumGInput
...
from .petrol_type_enum_g_input import PetrolTypeEnumGInput
...
@validataclass
class PetrolRefillPointInput(ValidataclassMixin):
    ...
    petrolType: PetrolTypeEnumGInput | UnsetValueType = DataclassValidator(PetrolTypeEnumGInput), Default(UnsetValue)
    octaneType: OctaneTypeEnumGInput | UnsetValueType = DataclassValidator(OctaneTypeEnumGInput), Default(UnsetValue)
    octane: int | UnsetValueType = IntegerValidator(min_value=0), Default(UnsetValue)
    bioethanolShare: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    bioethanolType: BioethanolTypeEnumGInput | UnsetValueType = (
        DataclassValidator(BioethanolTypeEnumGInput),
        Default(UnsetValue),
    )
    ...
    aegiPetrolRefillPointExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
