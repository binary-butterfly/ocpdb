...
from webapp.shared.datex2.v3_7.shared.access_junction_input import AccessJunctionInput
from webapp.shared.datex2.v3_7.shared.access_lane_specific_input import AccessLaneSpecificInput
...
class VehicularAccessInput(ValidataclassMixin):
    ...
    rentalCarReturn: bool | UnsetValueType = BooleanValidator(), Default(UnsetValue)
    usableForPedestrian: bool | UnsetValueType = BooleanValidator(), Default(UnsetValue)
    ...
    accessLaneSpecific: list[AccessLaneSpecificInput] | UnsetValueType = (
        ListValidator(DataclassValidator(AccessLaneSpecificInput)),
        Default(UnsetValue),
    )
    correspondingJunction: AccessJunctionInput | UnsetValueType = (
        DataclassValidator(AccessJunctionInput),
        Default(UnsetValue),
    )
    ...
    prkVehicularAccessExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
