...
from webapp.shared.datex2.v3_7.shared.environmental_obstruction_type_enum_g_input import (
    EnvironmentalObstructionTypeEnumGInput,
)
...
@validataclass
class EnvironmentalObstructionInput(ValidataclassMixin):
    ...
    depth: float | UnsetValueType = FloatValidator(allow_integers=True), Default(UnsetValue)
    environmentalObstructionType: EnvironmentalObstructionTypeEnumGInput = DataclassValidator(
        EnvironmentalObstructionTypeEnumGInput
    )
    ...
    sitEnvironmentalObstructionExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
