...
@validataclass
class RatesPublicationInput(ValidataclassMixin):
    ...
    rateMatrix: list[RateMatrixInput] = ListValidator(DataclassValidator(RateMatrixInput))
    comPayloadPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
    facRatesPublicationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
