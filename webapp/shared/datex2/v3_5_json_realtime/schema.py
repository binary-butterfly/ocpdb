...
# --- Shared schemas (same structure as static, but separate components for the realtime context) ---

facility_object_versioned_reference_g_schema = JsonSchema(
    title='Datex2RealtimeFacilityObjectVersionedReferenceG',
...
facility_object_versioned_reference_g_component = Component(
    'Datex2RealtimeFacilityObjectVersionedReferenceG',
...
international_identifier_schema = JsonSchema(
    title='Datex2RealtimeInternationalIdentifier',
...
international_identifier_component = Component(
    'Datex2RealtimeInternationalIdentifier', international_identifier_schema, international_identifier_example
)
...
refill_point_status_enum_g_schema = JsonSchema(
    title='Datex2RealtimeRefillPointStatusEnumG',
...
refill_point_status_enum_g_component = Component(
    'Datex2RealtimeRefillPointStatusEnumG',
...
refill_point_status_schema = JsonSchema(
    title='Datex2RealtimeRefillPointStatus',
    description='Status information for a single refill point / EVSE.',
    properties={
        'reference': Reference(
            obj='Datex2RealtimeFacilityObjectVersionedReferenceG',
        ...
        'status': Reference(
            obj='Datex2RealtimeRefillPointStatusEnumG',
...
refill_point_status_component = Component(
    'Datex2RealtimeRefillPointStatus', refill_point_status_schema, refill_point_status_example
)


refill_point_status_g_schema = JsonSchema(
    title='Datex2RealtimeRefillPointStatusG',
    ...
    properties={
        'aegiRefillPointStatus': Reference(
            obj='Datex2RealtimeRefillPointStatus',
            required=False,
...
refill_point_status_g_component = Component(
    'Datex2RealtimeRefillPointStatusG', refill_point_status_g_schema, refill_point_status_g_example
)
...
energy_infrastructure_station_status_schema = JsonSchema(
    title='Datex2RealtimeEnergyInfrastructureStationStatus',
    ...
    properties={
        ...
        'refillPointStatus': ArrayField(
            items=Reference(obj='Datex2RealtimeRefillPointStatusG'),
            required=False,
...
energy_infrastructure_station_status_component = Component(
    'Datex2RealtimeEnergyInfrastructureStationStatus',
...
energy_infrastructure_site_status_schema = JsonSchema(
    title='Datex2RealtimeEnergyInfrastructureSiteStatus',
    ...
    properties={
        ...
        'energyInfrastructureStationStatus': ArrayField(
            items=Reference(obj='Datex2RealtimeEnergyInfrastructureStationStatus'),
            required=False,
...
energy_infrastructure_site_status_component = Component(
    'Datex2RealtimeEnergyInfrastructureSiteStatus',
...
energy_infrastructure_status_publication_schema = JsonSchema(
    title='Datex2RealtimeEnergyInfrastructureStatusPublication',
    ...
    properties={
        ...
        'publicationCreator': Reference(
            obj='Datex2RealtimeInternationalIdentifier',
            description='Creator of the publication.',
        ),
        'energyInfrastructureSiteStatus': ArrayField(
            items=Reference(obj='Datex2RealtimeEnergyInfrastructureSiteStatus'),
            required=False,
...
energy_infrastructure_status_publication_component = Component(
    'Datex2RealtimeEnergyInfrastructureStatusPublication',
...
payload_publication_g_schema = JsonSchema(
    title='Datex2RealtimePayloadPublicationG',
    description='DATEX II realtime payload publication with version information and status publication.',
    properties={
        ...
        'aegiEnergyInfrastructureStatusPublication': Reference(
            obj='Datex2RealtimeEnergyInfrastructureStatusPublication',
            required=False,
...
payload_publication_g_component = Component(
    'Datex2RealtimePayloadPublicationG', payload_publication_g_schema, payload_publication_g_example
)


datex2_v35_realtime_payload_schema = JsonSchema(
    title='Datex2V35RealtimePayload',
    description='DATEX II v3.5 realtime payload for energy infrastructure status.',
    properties={
        'payload': Reference(
            obj='Datex2RealtimePayloadPublicationG',
            required=False,
...
datex2_v35_realtime_payload_example = {'payload': payload_publication_g_example}

datex2_v35_realtime_payload_component = Component(
    'Datex2V35RealtimePayload', datex2_v35_realtime_payload_schema, datex2_v35_realtime_payload_example
)


# --- Component list for use with @document ---

all_datex2_v35_realtime_components = [
    datex2_v35_realtime_payload_component,
