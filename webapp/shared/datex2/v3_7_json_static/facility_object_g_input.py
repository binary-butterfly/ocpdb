...
@validataclass
class FacilityObjectGInput(ValidataclassMixin):
    """
    ...
    egiEnergyInfrastructureStation: EnergyInfrastructureStationInput | UnsetValueType = (
        DataclassValidator(EnergyInfrastructureStationInput),
        Default(UnsetValue),
    )
    egiEnergyInfrastructureSite: EnergyInfrastructureSiteInput | UnsetValueType = (
