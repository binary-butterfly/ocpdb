...
@validataclass
class GeneralRateInformationInput(ValidataclassMixin):
    """
    Some general rates and payment information without specifying rates as such.
    """
    ...
    facGeneralRateInformationExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
