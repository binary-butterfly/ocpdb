...
refill_point_g_schema = JsonSchema(
    ...
    properties={
        'egiElectricChargingPoint': Reference(
...
refill_point_g_example = {'egiElectricChargingPoint': electric_charging_point_example}
...
organisation_g_schema = JsonSchema(
    ...
    properties={
        'facOrganisationSpecification': Reference(
            obj='Datex2V37OrganisationSpecification',
            required=False,
            description='An organisation specification with ID and version.',
        ),
    },
)

organisation_g_example = {'facOrganisationSpecification': organisation_specification_example}
...
operating_hours_g_example = {'facOpenAllHours': {}}
...
payload_publication_g_schema = JsonSchema(
    ...
    properties={
        ...
        'egiEnergyInfrastructureTablePublication': Reference(
...
payload_publication_g_example = {
    ...
    'egiEnergyInfrastructureTablePublication': energy_infrastructure_table_publication_example,
}
