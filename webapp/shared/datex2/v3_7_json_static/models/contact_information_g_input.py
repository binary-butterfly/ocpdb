...
class ContactInformationGInput(ValidataclassMixin):
    ...
    facContactInformation: ContactInformationInput | UnsetValueType = (
        DataclassValidator(ContactInformationInput),
        Default(UnsetValue),
    )
    facContactPerson: ContactPersonInput | UnsetValueType = DataclassValidator(ContactPersonInput), Default(UnsetValue)
