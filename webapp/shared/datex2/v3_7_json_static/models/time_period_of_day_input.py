...
class TimePeriodOfDayInput(ValidataclassMixin):
    """
    Specification of a continuous period of time within a 24 hour period. If endTime is before startTime then endTime should be interpreted as being in the following day.
    """
