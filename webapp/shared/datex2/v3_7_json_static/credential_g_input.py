...
class CredentialGInput(ValidataclassMixin):
    ...
    facCredential: CredentialInput | UnsetValueType = DataclassValidator(CredentialInput), Default(UnsetValue)
    facCredentialAssigned: CredentialAssignedInput | UnsetValueType = (
