...
from .facility_object_status_input import FacilityObjectStatusInput
...
@validataclass
class FacilityObjectStatusGInput(ValidataclassMixin):
    afacFacilityObjectStatus: FacilityObjectStatusInput | UnsetValueType = (
        DataclassValidator(FacilityObjectStatusInput),
        Default(UnsetValue),
    )
    ...
    afacSupplementalFacilityStatus: SupplementalFacilityStatusInput | UnsetValueType = (
        DataclassValidator(SupplementalFacilityStatusInput),
        Default(UnsetValue),
    )
