...
from validataclass.validators import AnyOfValidator, DateTimeValidator, StringValidator
...
class TariffSearchQuery(SortingMixin, OffsetPaginationMixin, BaseSearchQuery):
