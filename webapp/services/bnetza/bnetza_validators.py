...
from webapp.common.validation import NumericToFloatValidator, EmptystringToNoneable, IntegerToStringValidator, \
    CommaStringToFloatValidator, PrintableStringValidator, DateTimeToUtcDateTimeValidator
...
class BnetzaRowInput:
    ...
    lat: float = CommaStringToFloatValidator()
    lon: float = CommaStringToFloatValidator()
    launch_date: datetime = DateTimeToUtcDateTimeValidator()
    connection_power: float = NumericToFloatValidator()
    ...
    connector_1_power: Optional[float] = EmptystringToNoneable(NumericToFloatValidator())
    ...
    connector_2_power: Optional[float] = EmptystringToNoneable(NumericToFloatValidator())
    ...
    connector_3_power: Optional[float] = EmptystringToNoneable(NumericToFloatValidator())
    ...
    connector_4_power: Optional[float] = EmptystringToNoneable(NumericToFloatValidator())
