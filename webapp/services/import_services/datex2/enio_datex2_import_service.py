...
class EnioDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_enio',
        name='Enio Datex II',
        public_url='https://mobilithek.info/offers/963766220171735040',
        source_url='https://mobilithek.info/offers/963766220171735040',
