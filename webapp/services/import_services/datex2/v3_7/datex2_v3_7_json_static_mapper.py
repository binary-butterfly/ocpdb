...
from webapp.shared.datex2.v3_7.shared.accessibility_enum import AccessibilityEnum
from webapp.shared.datex2.v3_7.shared.address_line_type_enum import AddressLineTypeEnum
from webapp.shared.datex2.v3_7.shared.afir_facility_location_input import AfirFacilityLocationInput
...
from webapp.shared.datex2.v3_7.shared.connector_input import ConnectorInput as DatexConnectorInput
...
from webapp.shared.datex2.v3_7.shared.price_type_enum import PriceTypeEnum
from webapp.shared.datex2.v3_7.shared.rate_policy_enum import RatePolicyEnum
from webapp.shared.datex2.v3_7.shared.refill_point_status_enum import RefillPointStatusEnum
from webapp.shared.datex2.v3_7.shared.service_type_enum import ServiceTypeEnum
...
from webapp.shared.datex2.v3_7.static.energy_infrastructure_station_input import EnergyInfrastructureStationInput
...
class Datex2V37JSONStaticMapper:
    ...
    def get_coordinates_by_location_reference(
        location_reference: StaticLocationReferenceGInput,
    ) -> PointCoordinatesInput | None:
    ...
    def _get_facility_location(
        self, energy_infrastructure_site: EnergyInfrastructureSiteInput
    ) -> AfirFacilityLocationInput | None:
        if energy_infrastructure_site.locationReference:
            facility = self._get_facility_location_by_location_reference(
    ...
    def _get_facility_location_by_location_reference(
        ...
        if location_reference.locPointLocation and location_reference.locPointLocation.locLocationExtensionG:
            return location_reference.locPointLocation.locLocationExtensionG.AfirFacilityLocation

        if location_reference.locAreaLocation and location_reference.locAreaLocation.locLocationExtensionG:
            return location_reference.locAreaLocation.locLocationExtensionG.AfirFacilityLocation

        return None

    def _apply_point_location(self, facility_location: AfirFacilityLocationInput, location: LocationUpdate) -> None:
        ...
        for address_line in facility_location.address.addressLine:
            if address_line.type.value == AddressLineTypeEnum.STREET:
                ...
                address_fragments.append(self.get_multilanguage_string(address_line.text))
        location.address = ' '.join(fragment for fragment in address_fragments if fragment)
    ...
    def _apply_energy_infrastructure_stations(
        ...
        if energy_infrastructure_station.totalMaximumPower:
            charge_station.max_power = MaxPowerUpdate(
    ...
    def _apply_energy_mix(self, charging_point: ElectricChargingPointInput, location: LocationUpdate):
        ...
        for energy_product in charging_point.energyProduct:
            ...
            if electric_energy is UnsetValue:
                continue
    ...
    @classmethod
    def _map_service_type(cls, service_types: list[ServiceTypeInput] | UnsetValueType) -> ServiceType | None:
        if service_types is UnsetValue:
            return None
    ...
    def _map_standard(connector_type: ConnectorTypeEnum) -> ConnectorType | None:
        return {
            ...
            ConnectorTypeEnum.DOMESTICATYPE: ConnectorType.DOMESTIC_A,
            ConnectorTypeEnum.DOMESTICBTYPE: ConnectorType.DOMESTIC_B,
            ConnectorTypeEnum.DOMESTICCTYPE: ConnectorType.DOMESTIC_C,
            ConnectorTypeEnum.DOMESTICDTYPE: ConnectorType.DOMESTIC_D,
            ConnectorTypeEnum.DOMESTICETYPE: ConnectorType.DOMESTIC_E,
            ConnectorTypeEnum.DOMESTICFTYPE: ConnectorType.DOMESTIC_F,
            ConnectorTypeEnum.DOMESTICGTYPE: ConnectorType.DOMESTIC_G,
            ConnectorTypeEnum.DOMESTICHTYPE: ConnectorType.DOMESTIC_H,
            ConnectorTypeEnum.DOMESTICITYPE: ConnectorType.DOMESTIC_I,
            ConnectorTypeEnum.DOMESTICJTYPE: ConnectorType.DOMESTIC_J,
            ConnectorTypeEnum.DOMESTICKTYPE: ConnectorType.DOMESTIC_K,
            ConnectorTypeEnum.DOMESTICLTYPE: ConnectorType.DOMESTIC_L,
