...
class PublicHolidayInput:
    ...
    publicHolidayName: MultilingualStringInput = DataclassValidator(MultilingualStringInput)
    ...
    comPublicHolidayExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
