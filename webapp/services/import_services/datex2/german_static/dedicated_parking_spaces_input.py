...
@validataclass
class DedicatedParkingSpacesInput:
    ...
    numberOfSpaces: int = IntegerValidator(min_value=0)
    userSpecific: list[UserTypeEnumGInput] | UnsetValueType = (
    ...
    aegiDedicatedParkingSpacesExtensionG: ExtensionTypeGInput | UnsetValueType = (
        DataclassValidator(ExtensionTypeGInput),
        Default(UnsetValue),
    )
