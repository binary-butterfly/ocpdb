...
class LichtblickDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_lichtblick',
        name='Lichtblick Datex II',
        public_url='https://mobilithek.info/offers/962721207430316032',
        source_url='https://mobilithek.info/offers/962721207430316032',
