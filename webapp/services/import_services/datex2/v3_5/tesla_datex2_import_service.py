...
class TeslaDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_tesla',
        name='Tesla Datex II',
        public_url='https://mobilithek.info/offers/953828817873125376',
        source_url='https://mobilithek.info/offers/953828817873125376',
