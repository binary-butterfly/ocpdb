...
class EClearingNetDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_e_clearing_net',
        name='e-clearing.net Datex II',
        public_url='https://mobilithek.info/offers/996825300704600064',
        source_url='https://mobilithek.info/offers/996825300704600064',
