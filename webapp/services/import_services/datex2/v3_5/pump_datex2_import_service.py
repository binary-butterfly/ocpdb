...
class PumpDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_pump',
        name='Pump Datex II',
        public_url='https://mobilithek.info/offers/969322788846231552',
        source_url='https://mobilithek.info/offers/969322788846231552',
