...
class ErftDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_erft',
        name='Erft Datex II',
        public_url='https://mobilithek.info/offers/982969565784539136',
        source_url='https://mobilithek.info/offers/982969565784539136',
