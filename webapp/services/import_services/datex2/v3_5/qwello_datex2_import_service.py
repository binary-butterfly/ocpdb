...
class QwelloDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_qwello',
        name='Qwello Datex II',
        public_url='https://mobilithek.info/offers/972963216296222720',
        source_url='https://mobilithek.info/offers/972963216296222720',
