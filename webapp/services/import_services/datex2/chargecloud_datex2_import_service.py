...
class ChargecloudDatex2ImportService(BaseDatex2V35ImportService):
    source_info = SourceInfo(
        uid='datex2_chargecloud',
        name='Chargecloud Datex II',
        public_url='https://mobilithek.info/offers/978597062404620288',
        source_url='https://mobilithek.info/offers/978597062404620288',
