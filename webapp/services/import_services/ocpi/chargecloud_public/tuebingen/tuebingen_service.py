...
class TuebingenImportService(ChargecloudPublicBaseImportService):
    source_info = SourceInfo(
        uid='chargecloud_tuebingen',
        name='Stadtwerke Tübingen',
        public_url='https://www.swtue.de/e-mobilitaet/ladestationen-in-tuebingen.html',
        source_url='https://new-poi.chargecloud.de/tuebingen',
